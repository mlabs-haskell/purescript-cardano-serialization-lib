...
export const bootstrapWitness_new = vkey => signature => chain_code => attributes =>
...
export const certificate_newMoveInstantaneousRewardsCert = move_instantaneous_rewards_cert =>
  CSL.Certificate.new_move_instantaneous_rewards_cert(move_instantaneous_rewards_cert);
...
export const certificate_newStakeAndVoteDelegation = stake_and_vote_delegation =>
...
export const certificate_newStakeRegistrationAndDelegation =
  stake_registration_and_delegation =>
    CSL.Certificate.new_stake_registration_and_delegation(stake_registration_and_delegation);
...
export const certificate_newVoteRegistrationAndDelegation = vote_registration_and_delegation =>
  CSL.Certificate.new_vote_registration_and_delegation(vote_registration_and_delegation);
...
// CommitteeColdResign
export const committeeColdResign_committeeColdKey = self =>
  self.committee_cold_key.bind(self)();
export const committeeColdResign_anchor = self => self.anchor.bind(self)();
export const committeeColdResign_new = committee_cold_key =>
  CSL.CommitteeColdResign.new(committee_cold_key);
export const committeeColdResign_newWithAnchor = committee_cold_key => anchor =>
  CSL.CommitteeColdResign.new_with_anchor(committee_cold_key, anchor);
...
export const committeeHotAuth_new = committee_cold_key => committee_hot_key =>
  CSL.CommitteeHotAuth.new(committee_cold_key, committee_hot_key);
...
export const drepRegistration_newWithAnchor = voting_credential => coin => anchor =>
...
export const drepVotingThresholds_setMotionNoConfidence = self => motion_no_confidence => () =>
  self.set_motion_no_confidence.bind(self)(motion_no_confidence);
export const drepVotingThresholds_setCommitteeNormal = self => committee_normal => () =>
...
export const drepVotingThresholds_setUpdateConstitution = self => update_constitution => () =>
  self.set_update_constitution.bind(self)(update_constitution);
export const drepVotingThresholds_setHardForkInitiation = self => hard_fork_initiation => () =>
  self.set_hard_fork_initiation.bind(self)(hard_fork_initiation);
export const drepVotingThresholds_setPpNetworkGroup = self => pp_network_group => () =>
  self.set_pp_network_group.bind(self)(pp_network_group);
export const drepVotingThresholds_setPpEconomicGroup = self => pp_economic_group => () =>
  self.set_pp_economic_group.bind(self)(pp_economic_group);
export const drepVotingThresholds_setPpTechnicalGroup = self => pp_technical_group => () =>
  self.set_pp_technical_group.bind(self)(pp_technical_group);
export const drepVotingThresholds_setPpGovernanceGroup = self => pp_governance_group => () =>
  self.set_pp_governance_group.bind(self)(pp_governance_group);
export const drepVotingThresholds_setTreasuryWithdrawal = self => treasury_withdrawal => () =>
...
export const genesisKeyDelegation_new = genesishash => genesis_delegate_hash => vrf_keyhash =>
  CSL.GenesisKeyDelegation.new(genesishash, genesis_delegate_hash, vrf_keyhash);

// GovernanceAction
export const governanceAction_newParameterChangeAction = parameter_change_action =>
  CSL.GovernanceAction.new_parameter_change_action(parameter_change_action);
export const governanceAction_newHardForkInitiationAction = hard_fork_initiation_action =>
  CSL.GovernanceAction.new_hard_fork_initiation_action(hard_fork_initiation_action);
export const governanceAction_newTreasuryWithdrawalsAction = treasury_withdrawals_action =>
  CSL.GovernanceAction.new_treasury_withdrawals_action(treasury_withdrawals_action);
...
export const governanceAction_newNewConstitutionAction = new_constitution_action =>
...
export const hardForkInitiationAction_newWithActionId = gov_action_id => protocol_version =>
  CSL.HardForkInitiationAction.new_with_action_id(gov_action_id, protocol_version);
...
export const multiAsset_setAsset = self => policy_id => asset_name => value => () =>
...
export const nativeScriptSource_newRefInput = script_hash => input =>
  CSL.NativeScriptSource.new_ref_input(script_hash, input);
...
export const newConstitutionAction_newWithActionId = gov_action_id => constitution =>
...
export const operationalCert_new = hot_vkey => sequence_number => kes_period => sigma =>
...
export const parameterChangeAction_newWithActionId = gov_action_id => protocol_param_updates =>
  CSL.ParameterChangeAction.new_with_action_id(gov_action_id, protocol_param_updates);
export const parameterChangeAction_newWithPolicyHash = protocol_param_updates => policy_hash =>
  CSL.ParameterChangeAction.new_with_policy_hash(protocol_param_updates, policy_hash);
...
export const plutusData_newSingleValueConstrPlutusData = alternative => plutus_data =>
  CSL.PlutusData.new_single_value_constr_plutus_data(alternative, plutus_data);
...
export const plutusScriptSource_newRefInput =
  script_hash => input => lang_ver => script_size =>
    CSL.PlutusScriptSource.new_ref_input(script_hash, input, lang_ver, script_size);
...
export const protocolParamUpdate_setMaxBlockBodySize = self => max_block_body_size => () =>
...
export const protocolParamUpdate_setMaxBlockHeaderSize = self => max_block_header_size => () =>
...
export const protocolParamUpdate_setExpansionRate = self => expansion_rate => () =>
...
export const protocolParamUpdate_setTreasuryGrowthRate = self => treasury_growth_rate => () =>
...
export const protocolParamUpdate_setProtocolVersion = self => protocol_version => () =>
...
export const protocolParamUpdate_setAdaPerUtxoByte = self => ada_per_utxo_byte => () =>
...
export const protocolParamUpdate_setExecutionCosts = self => execution_costs => () =>
...
export const protocolParamUpdate_setMaxTxExUnits = self => max_tx_ex_units => () =>
...
export const protocolParamUpdate_setMaxBlockExUnits = self => max_block_ex_units => () =>
...
export const protocolParamUpdate_setMaxValueSize = self => max_value_size => () =>
...
export const protocolParamUpdate_setMinCommitteeSize = self => min_committee_size => () =>
...
export const protocolParamUpdate_setCommitteeTermLimit = self => committee_term_limit => () =>
...
export const protocolParamUpdate_setGovernanceActionValidityPeriod =
  self => governance_action_validity_period => () =>
    self.set_governance_action_validity_period.bind(self)(governance_action_validity_period);
...
export const stakeAndVoteDelegation_new = stake_credential => pool_keyhash => drep =>
...
export const stakeDeregistration_newWithCoin = stake_credential => coin =>
  CSL.StakeDeregistration.new_with_coin(stake_credential, coin);
...
export const stakeRegistration_newWithCoin = stake_credential => coin =>
  CSL.StakeRegistration.new_with_coin(stake_credential, coin);
...
export const stakeRegistrationAndDelegation_new = stake_credential => pool_keyhash => coin =>
  CSL.StakeRegistrationAndDelegation.new(stake_credential, pool_keyhash, coin);
...
export const stakeVoteRegistrationAndDelegation_new =
  stake_credential => pool_keyhash => drep => coin =>
    CSL.StakeVoteRegistrationAndDelegation.new(stake_credential, pool_keyhash, drep, coin);
...
export const transactionBody_setAuxiliaryDataHash = self => auxiliary_data_hash => () =>
...
export const transactionBody_setCollateralReturn = self => collateral_return => () =>
...
export const transactionBody_setTotalCollateral = self => total_collateral => () =>
...
export const transactionBody_setVotingProcedures = self => voting_procedures => () =>
...
export const transactionBody_setVotingProposals = self => voting_proposals => () =>
...
export const transactionBody_setCurrentTreasuryValue = self => current_treasury_value => () =>
...
export const transactionWitnessSet_setNativeScripts = self => native_scripts => () =>
  self.set_native_scripts.bind(self)(native_scripts);
...
export const transactionWitnessSet_setPlutusScripts = self => plutus_scripts => () =>
  self.set_plutus_scripts.bind(self)(plutus_scripts);
...
export const treasuryWithdrawalsAction_newWithPolicyHash = withdrawals => policy_hash =>
  CSL.TreasuryWithdrawalsAction.new_with_policy_hash(withdrawals, policy_hash);
...
export const updateCommitteeAction_newWithActionId =
  gov_action_id => committee => members_to_remove =>
    CSL.UpdateCommitteeAction.new_with_action_id(gov_action_id, committee, members_to_remove);
...
export const voteRegistrationAndDelegation_new = stake_credential => drep => coin =>
...
// Voter
export const voter_newConstitutionalCommitteeHotKey = cred =>
  CSL.Voter.new_constitutional_committee_hot_key(cred);
...
export const voter_toConstitutionalCommitteeHotCred = self =>
  self.to_constitutional_committee_hot_cred.bind(self)();
